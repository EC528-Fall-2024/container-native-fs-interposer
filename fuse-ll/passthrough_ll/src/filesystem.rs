...
pub use fuse2::{FsOptions, OpenOptions, RemovemappingOne, SetattrValid, SetxattrFlags, ROOT_ID};
...
impl From<Entry> for fuse2::EntryOut {
    fn from(entry: Entry) -> fuse2::EntryOut {
        fuse2::EntryOut {
            nodeid: entry.inode,
            ...
            attr: fuse2::Attr::with_flags(entry.attr, entry.attr_flags),
        }
    }
}
...
impl From<fuse2::InHeader> for Context {
    fn from(source: fuse2::InHeader) -> Self {
        Context {
            uid: source.uid,
            gid: source.gid,
